odoo.define('ecommerce_coupon.test', function (require) {
'use strict';

require("ecommerce.tour");
var tour = require("web_tour.tour");
var ajax = require('web.ajax');
const tourUtils = require('ecommerce.tour_utils');
    ...
    [
        {
            ...
            extra_trigger: '.oe_ecommerce .o_wsale_products_searchbar_form',
        ...
        {
            content: "open customize menu",
            extra_trigger: '.oe_ecommerce .oe_cart',
            trigger: '#customize-menu > a',
        },
        {
