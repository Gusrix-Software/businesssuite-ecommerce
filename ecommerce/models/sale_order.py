...
class SaleOrder(models.Model):
    ...
    is_abandoned_cart = fields.Boolean('Abandoned Cart', compute='_compute_abandoned_cart',
    ...
    def _website_product_id_change(self, order_id, product_id, qty=0, **kwargs):
        ...
        if order.pricelist_id.discount_policy == 'without_discount':
            ...
            if order.pricelist_id and order.partner_id:
                ...
                if order_line:
                    price = self.env['account.tax']._fix_tax_included_price_company(price, product.taxes_id,
                                                                                    order_line[0].tax_id,
                                                                                    self.company_id)
    ...
    def _cart_accessories(self):
        ...
        for order in self:
            ...
            for line in order.website_order_line.filtered(lambda l: l.product_id):
                ...
                accessory_products |= line.product_id.product_tmpl_id._get_website_accessory_product().filtered(
                    lambda product:
    ...
    def action_recovery_email_send(self):
        ...
        return {
            ...
            'context': {
                ...
                'ecommerce_send_recovery_email': True,
                'active_ids': self.ids,
            },
        }
    ...
    def _get_cart_recovery_template(self):
        ...
        template = template or self.env.ref('ecommerce.mail_template_sale_cart_recovery', raise_if_not_found=False)
...
class SaleOrderLine(models.Model):
    ...
    linked_line_id = fields.Many2one('sale.order.line', string='Linked Order Line',
                                     domain="[('order_id', '=', order_id)]", ondelete='cascade', copy=False)
