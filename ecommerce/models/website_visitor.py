...
class WebsiteVisitor(models.Model):
    ...
    visitor_product_count = fields.Integer('Product Views', compute="_compute_product_statistics",
    ...
    product_count = fields.Integer('Products Views', compute="_compute_product_statistics",
