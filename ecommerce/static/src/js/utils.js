odoo.define('ecommerce.utils', function (require) {
    'use strict';
    ...
    function updateCartNavBar(data) {
        ...
        $(".js_cart_lines").first().before(data['ecommerce.cart_lines']).end().remove();
        $(".js_cart_summary").first().before(data['ecommerce.short_cart_summary']).end().remove();
    }
