odoo.define('ecommerce.cart', function (require) {
    'use strict';
        ...
        _onMouseEnter: function (ev) {
            ...
            timeout = setTimeout(function () {
                ...
                self._popoverRPC = $.get("/shop/cart", {
                    ...
                    self.$el.data("popover").config.content = data;
...
odoo.define('ecommerce.ecommerce_category', function (require) {
    'use strict';
...
odoo.define('ecommerce.ecommerce', function (require) {
    'use strict';

    var core = require('web.core');
    var config = require('web.config');
    var publicWidget = require('web.public.widget');
    var VariantMixin = require('ecommerce.VariantMixin');
    ...
    publicWidget.registry.websiteSaleCarouselProduct = publicWidget.Widget.extend({
        ...
        async start() {
            ...
            if (this.$target.find('.carousel-indicators').length > 0) {
                this.$target.on('slide.carousel.carousel_product_slider', this._onSlideCarouselProduct.bind(this));
...
odoo.define('ecommerce.price_range_option', function (require) {
    'use strict';
