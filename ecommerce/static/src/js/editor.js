odoo.define('ecommerce.add_product', function (require) {
    'use strict';
...
odoo.define('ecommerce.editMenu', function (require) {
    'use strict';
    ...
    WebsiteEditMenu.include({
        ...
        _getContentEditableAreas() {
            return $(this.savableSelector).not('input, [data-oe-readonly],[data-oe-type="monetary"],[data-oe-many2one-id], [data-oe-field="arch"]:empty').filter((_, el) => {
                return !$(el).closest('.o_not_editable, .oe_ecommerce .products_header').length;
            }).toArray();
        },
        /**
         * @override
         */
        _getReadOnlyAreas() {
            return $("#wrapwrap").find('.oe_ecommerce .products_header, .oe_ecommerce .products_header a').toArray();
        },
    });
});
...
odoo.define('ecommerce.editor', function (require) {
    'use strict';
    ...
    options.registry.WebsiteSaleProductsItem = options.Class.extend({
        xmlDependencies: (options.Class.prototype.xmlDependencies || []).concat(['/ecommerce/static/src/xml/utils.xml']),
        ...
        async _renderCustomXML(uiFragment) {
            ...
            Object.values(this.ribbons).forEach(ribbon => {
                const colorClasses = ribbon.html_class
                    ...
                    .join(' ');
                $select.append(qweb.render('ecommerce.ribbonSelectItem', {
                    ribbon,
                    colorClasses,
