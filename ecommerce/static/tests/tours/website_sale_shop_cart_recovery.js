odoo.define('ecommerce.tour_shop_cart_recovery', function (require) {
    'use strict';
    ...
    var orderIdKey = 'ecommerce.tour_shop_cart_recovery.orderId';
    var recoveryLinkKey = 'ecommerce.tour_shop_cart_recovery.recoveryLink';
